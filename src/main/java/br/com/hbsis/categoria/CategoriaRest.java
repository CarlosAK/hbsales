...
public class CategoriaRest {
    ...
    @Autowired
    public CategoriaRest(CategoriaService categoriaService, br.com.hbsis.categoria.CategoriaService categoriaService1) {
        this.categoriaService = categoriaService;

    }

    @PostMapping("/importa-categorias")
