...
public class CategoriaService {
    ...
    public void csvTocategoriaExport(HttpServletResponse response) throws Exception {
        ...
        for (Categoria linha : iCategoriaRepository.findAll()) {
            csvWriter.writeNext(new String[]{linha.getCodCategoria(), linha.getNomeCategoria(), linha.getFornecedor().getRazaoSocial(), mascaraCnpj(linha.getFornecedor().getCnpj())}
    ...
    public CategoriaDTO save(CategoriaDTO categoriaDTO) {
        ...
        String codigo = categoriaDTO.getCodCategoria();
        String codigoComZero = codigoValidar(codigo);

        categoria.setCodCategoria(incial + ultDig + codigoComZero);
    ...
    private void validate(CategoriaDTO categoriaDTO) {
        ...
        if (StringUtils.isEmpty(Long.toString(categoriaDTO.getFornecedor()))) {
            throw new IllegalArgumentException("Fornecedor categoria não cadastrado");

        }

        if (StringUtils.isEmpty(categoriaDTO.getNomeCategoria())) {
            throw new IllegalArgumentException("Nome categoria não deve ser nulo/vazio");

        }

        if (StringUtils.isEmpty(categoriaDTO.getCodCategoria())) {
            throw new IllegalArgumentException("Codigo categoria não deve ser nulo/vazio");
    ...
    public CategoriaDTO update(CategoriaDTO categoriaDTO, Long id) {
        ...
        if (categoriaExistenteOptional.isPresent()) {
            ...
            categoriaExistente.setCodCategoria(incial + ultDig + codigoComZero);
